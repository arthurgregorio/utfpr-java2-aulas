...
public class Video08DateTime {
    ...
    void main() {
        ...
        IO.println("Ate o Natal: " + ateNatal.getMonths() + " meses e " + ateNatal.getDays() + " dias");
        ...
        final DateTimeFormatter formatoBrasil = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm");
